node(){
	...
	stage('Code Deployment'){
		deploy adapters: [tomcat9(credentialsId: 'TomcatCreds', path: '', url: 'http://lb-tomcat9-239161935.ap-south-1.elb.amazonaws.com:8080/')], contextPath: 'Planview', onFailure: false, war: 'target/*.war'
	}
}
